...
{
    public class FloatObservableModelsCatalogTest
    {
        private FloatObservableModelsCatalog _catalog;

        private (string, float)[] _models = new (string, float)[]
        {
            ("one", 1),
            ("two", 2),
            ("three", 3)
        ...
        public void SetUp()
        {
            _catalog = FloatObservableModelsCatalog.Create(_models);
        }
