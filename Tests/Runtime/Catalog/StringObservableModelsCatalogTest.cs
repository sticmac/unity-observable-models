...
{
    public class StringObservableModelsCatalogTest
    {
        private StringObservableModelsCatalog _catalog;

        private (string, string)[] _models = new (string, string)[]
        {
            ("one", "1"),
            ("two", "2"),
            ("three", "3")
        ...
        public void SetUp()
        {
            _catalog = StringObservableModelsCatalog.Create(_models);
        }
