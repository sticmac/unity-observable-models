...
{
    public class Vector2ObservableModelsCatalogTest
    {
        private Vector2ObservableModelsCatalog _catalog;

        private (string, Vector2)[] _models = new (string, Vector2)[]
        {
            ("one", Vector2.zero),
            ("two", Vector2.one),
            ("three", Vector2.right)
        ...
        public void SetUp()
        {
            _catalog = Vector2ObservableModelsCatalog.Create(_models);
        }
